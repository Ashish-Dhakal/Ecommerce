...
<section class="products">
    ...
    <div class="all-category">
        <div class="product">
            ...
            <a href="./electronicdevice.php" class="cate-btn"> Electronic Device</a>
        </div>
        ...
        <div class="product">
            ...
            <a href="./homeappliance.php" class="cate-btn"> Home Appliances</a>
        </div>
        ...
        <div class="product">
            ...
            <a href="./electronicacceories.php" class="cate-btn"> Electronic Acceories</a>
        </div>
        ...
        <div class="product">
            ...
            <a href="./gadget.php" class="cate-btn"> Gadgets</a>
        </div>
    </div>
...
<div class="category-info">
    <p class="cat-name">Electronic Device</p>
    <div class="show-more">
...
<div class="category-info">
    <p class="cat-name">TV and Home Appliance</p>
    <div class="show-more">
...
<div class="category-info">
    <p class="cat-name">Electronic Accessories</p>
    <div class="show-more">
